...
namespace InvoiceManagement.PayablesDataSetTableAdapters {
    ...
    public partial class GLAccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InvoiceManagement.Properties.Settings.Default.PayablesConnectionString;
        }
...
SELECT InvoiceID, VendorID, InvoiceNumber, InvoiceDate, InvoiceTotal, PaymentTotal, CreditTotal, TermsID, DueDate, PaymentDate FROM Invoices WHERE (InvoiceID = @InvoiceID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT IDENT_CURRENT(\'Invoices\') \r\nFROM Invoices";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
