          ...
          <tr>
            <td style="width: 460px" valign="top">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    DataObjectTypeName="Terms" SelectMethod="GetTerms" UpdateMethod="UpdateTerms" 
                    DeleteMethod="DeleteTerms" InsertMethod="InsertTerms" 
                    OldValuesParameterFormatString="original_{0}"
                    TypeName="TermsDB" ConflictDetection="CompareAllValues">
                    <UpdateParameters>
                        <asp:Parameter Name="original_Terms" Type="Object" />
                        <asp:Parameter Name="terms" Type="Object" />
                    </UpdateParameters>
