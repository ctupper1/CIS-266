...
<head id="Head1" runat="server">
    <title>Chapter 14: Display Vendors With Paging</title>
</head>
<body>
    ...
    <div>
        ...
        <asp:GridView ID="grdVendors" runat="server" AllowPaging="True" 
          DataSourceID="ObjectDataSourceVendors" 
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceVendors" runat="server" TypeName="VendorDB"
      EnablePaging="true"  
      SelectMethod="GetVendorsByPage" 
