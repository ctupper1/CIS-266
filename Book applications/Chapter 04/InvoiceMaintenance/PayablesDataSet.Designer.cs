...
namespace InvoiceMaintenance {
    ...
    public partial class PayablesDataSet : global::System.Data.DataSet {
        ...
        public partial class InvoiceLineItemsDataTable : global::System.Data.TypedTableBase<InvoiceLineItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InvoiceLineItemsRow AddInvoiceLineItemsRow(InvoicesRow parentInvoicesRowByFK_InvoiceLineItems_Invoices, short InvoiceSequence, int AccountNo, decimal Amount, string Description) {
        ...
        public partial class InvoicesDataTable : global::System.Data.TypedTableBase<InvoicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InvoicesRow AddInvoicesRow(VendorsRow parentVendorsRowByFK_Invoices_Vendors, string InvoiceNumber, System.DateTime InvoiceDate, decimal InvoiceTotal, decimal PaymentTotal, decimal CreditTotal, System.DateTime DueDate, System.DateTime PaymentDate) {
...
namespace InvoiceMaintenance.PayablesDataSetTableAdapters {
...
SELECT InvoiceID, InvoiceSequence, AccountNo, Amount, Description FROM InvoiceLineItems WHERE (InvoiceID = @InvoiceID) AND (InvoiceSequence = @InvoiceSequence)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InvoiceMaintenance.Properties.Settings.Default.PayablesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT     InvoiceID, InvoiceSequence, AccountNo, Amount, Description\r\nFROM      " +
    ...
    public partial class InvoicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Invoices] WHERE (([InvoiceID] = @Original_InvoiceID) AND ([VendorID] = @Original_VendorID) AND ([InvoiceNumber] = @Original_InvoiceNumber) AND ([InvoiceDate] = @Original_InvoiceDate) AND ([InvoiceTotal] = @Original_InvoiceTotal) AND ([PaymentTotal] = @Original_PaymentTotal) AND ([CreditTotal] = @Original_CreditTotal) AND ([DueDate] = @Original_DueDate) AND ((@IsNull_PaymentDate = 1 AND [PaymentDate] IS NULL) OR ([PaymentDate] = @Original_PaymentDate)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_InvoiceID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "InvoiceID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Invoices] SET [VendorID] = @VendorID, [InvoiceNumber] = @InvoiceNumber, [InvoiceDate] = @InvoiceDate, [InvoiceTotal] = @InvoiceTotal, [PaymentTotal] = @PaymentTotal, [CreditTotal] = @CreditTotal, [DueDate] = @DueDate, [PaymentDate] = @PaymentDate WHERE (([InvoiceID] = @Original_InvoiceID) AND ([VendorID] = @Original_VendorID) AND ([InvoiceNumber] = @Original_InvoiceNumber) AND ([InvoiceDate] = @Original_InvoiceDate) AND ([InvoiceTotal] = @Original_InvoiceTotal) AND ([PaymentTotal] = @Original_PaymentTotal) AND ([CreditTotal] = @Original_CreditTotal) AND ([DueDate] = @Original_DueDate) AND ((@IsNull_PaymentDate = 1 AND [PaymentDate] IS NULL) OR ([PaymentDate] = @Original_PaymentDate)));
SELECT InvoiceID, VendorID, InvoiceNumber, InvoiceDate, InvoiceTotal, PaymentTotal, CreditTotal, DueDate, PaymentDate FROM Invoices WHERE (InvoiceID = @InvoiceID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT InvoiceID, VendorID, InvoiceNumber, InvoiceDate, InvoiceTotal, PaymentTota" +
                "l, CreditTotal, DueDate, PaymentDate FROM dbo.Invoices";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT     InvoiceID, VendorID, InvoiceNumber, InvoiceDate, InvoiceTotal, Payment" +
                "Total, CreditTotal, DueDate, PaymentDate\r\nFROM         Invoices\r\nWHERE     (Vend" +
                "orID = @VendorID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_InvoiceID, int Original_VendorID, string Original_InvoiceNumber, System.DateTime Original_InvoiceDate, decimal Original_InvoiceTotal, decimal Original_PaymentTotal, decimal Original_CreditTotal, System.DateTime Original_DueDate, global::System.Nullable<global::System.DateTime> Original_PaymentDate) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_InvoiceID));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((System.DateTime)(Original_DueDate));
            if ((Original_PaymentDate.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(InvoiceID));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        public virtual int Update(
                    ...
                    System.DateTime Original_DueDate, 
                    global::System.Nullable<global::System.DateTime> Original_PaymentDate) {
            return this.Update(VendorID, InvoiceNumber, InvoiceDate, InvoiceTotal, PaymentTotal, CreditTotal, DueDate, PaymentDate, Original_InvoiceID, Original_VendorID, Original_InvoiceNumber, Original_InvoiceDate, Original_InvoiceTotal, Original_PaymentTotal, Original_CreditTotal, Original_DueDate, Original_PaymentDate, Original_InvoiceID);
        }
    }
    ...
    public partial class VendorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Vendors] WHERE (([VendorID] = @Original_VendorID) AND ([Name] = @Original_Name) AND ([Address1] = @Original_Address1) AND ((@IsNull_Address2 = 1 AND [Address2] IS NULL) OR ([Address2] = @Original_Address2)) AND ([City] = @Original_City) AND ([State] = @Original_State) AND ([ZipCode] = @Original_ZipCode))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_VendorID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "VendorID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Vendors] ([Name], [Address1], [Address2], [City], [State], [ZipCode]) VALUES (@Name, @Address1, @Address2, @City, @State, @ZipCode);
SELECT VendorID, Name, Address1, Address2, City, State, ZipCode FROM Vendors WHERE (VendorID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Vendors] SET [Name] = @Name, [Address1] = @Address1, [Address2] = @Address2, [City] = @City, [State] = @State, [ZipCode] = @ZipCode WHERE (([VendorID] = @Original_VendorID) AND ([Name] = @Original_Name) AND ([Address1] = @Original_Address1) AND ((@IsNull_Address2 = 1 AND [Address2] IS NULL) OR ([Address2] = @Original_Address2)) AND ([City] = @Original_City) AND ([State] = @Original_State) AND ([ZipCode] = @Original_ZipCode));
SELECT VendorID, Name, Address1, Address2, City, State, ZipCode FROM Vendors WHERE (VendorID = @VendorID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT VendorID, Name, Address1, Address2, City, State, ZipCode FROM dbo.Vendors";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT     VendorID, Name, Address1, Address2, City, State, ZipCode\r\nFROM        " +
