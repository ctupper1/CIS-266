...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="grdVendors" runat="server"  
          ...
          ForeColor="#333333" GridLines="None" AllowPaging="True" 
            DataSourceID="ObjectDataSourceVendorPaging"  >
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceVendorPaging" runat="server" 
        EnablePaging="True" MaximumRowsParameterName="maxRows" 
        SelectCountMethod="SelectCount" SelectMethod="GetVendorsByPage" 
        StartRowIndexParameterName="startIndex" TypeName="VendorDB">
