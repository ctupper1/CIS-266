...
<body>
    ...
    <div>
        ...
        <asp:DropDownList ID="ddlVendors" runat="server" 
            AutoPostBack="True" DataSourceID="ObjectDataSourceVendors"
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceVendors" runat="server" 
      OldValuesParameterFormatString="original_{0}" SelectMethod="GetVendorList" 
      TypeName="VendorDB" ></asp:ObjectDataSource>
    </form>
</body>
</html>
