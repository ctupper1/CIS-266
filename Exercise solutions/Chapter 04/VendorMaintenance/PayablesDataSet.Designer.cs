...
namespace VendorMaintenance.PayablesDataSetTableAdapters {
    ...
    public partial class VendorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Vendors] ([Name], [Address1], [Address2], [City], [State], [ZipCode], [Phone], [ContactLName], [ContactFName]) VALUES (@Name, @Address1, @Address2, @City, @State, @ZipCode, @Phone, @ContactLName, @ContactFName);
...
SELECT VendorID, Name, Address1, Address2, City, State, ZipCode, Phone, ContactLName, ContactFName FROM Vendors WHERE (VendorID = @VendorID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT VendorID, Name, Address1, Address2, City, State, ZipCode, Phone, ContactLN" +
                "ame, ContactFName FROM dbo.Vendors";
            ...
            this._commandCollection[2].CommandText = "SELECT     VendorID, Name, Address1, Address2, City, State, ZipCode, Phone, Conta" +
                "ctLName, ContactFName\r\nFROM         Vendors\r\nWHERE     (VendorID = @VendorID)";
        ...
        public virtual int FillByState(PayablesDataSet.VendorsDataTable dataTable, string State) {
