...
namespace PayablesData
{
    public static class VendorDB
    {
        public static Vendor GetVendor(int vendorID)
        {
            ...
            selectCommand.CommandText = "spGetVendor";
        ...
        public static bool DeleteVendor(Vendor vendor)
        {
            ...
            deleteCommand.Parameters.AddWithValue("@Name", vendor.Name);
            deleteCommand.Parameters.AddWithValue("@Address1", vendor.Address1);
            if (vendor.Address2 == "")
                deleteCommand.Parameters.AddWithValue("@Address2", DBNull.Value);
            else
                deleteCommand.Parameters.AddWithValue("@Address2",
                    vendor.Address2);
            deleteCommand.Parameters.AddWithValue("@City", vendor.City);
            deleteCommand.Parameters.AddWithValue("@State", vendor.State);
            deleteCommand.Parameters.AddWithValue("@ZipCode", vendor.ZipCode);
            if (vendor.Phone == "")
                deleteCommand.Parameters.AddWithValue("@Phone", DBNull.Value);
            else
                deleteCommand.Parameters.AddWithValue("@Phone", vendor.Phone);
            if (vendor.ContactFName == "")
                deleteCommand.Parameters.AddWithValue("@ContactFName",
                    DBNull.Value);
            else
                deleteCommand.Parameters.AddWithValue("@ContactFName",
                    vendor.ContactFName);
            if (vendor.ContactLName == "")
                deleteCommand.Parameters.AddWithValue("@ContactLName",
                    DBNull.Value);
            else
                deleteCommand.Parameters.AddWithValue("@ContactLName",
                    vendor.ContactLName);
            deleteCommand.Parameters.AddWithValue("@DefaultTermsID",
                vendor.DefaultTermsID);
            deleteCommand.Parameters.AddWithValue("@DefaultAccountNo",
                vendor.DefaultAccountNo);
